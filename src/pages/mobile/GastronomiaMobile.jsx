import './CSS/GastronomiaMobile.css'; // Novo arquivo CSS para mobile
...
const GastronomiaPageMobile = () => {
  return (
    <div id='gastronomia' className="gastronomia-page-mobile">
      <TitleMobile title="Gastronomia" color="white" />
      <div className="pratos-container-mobile">
        {pratos.map((prato, index) => (
          <div key={index} className="prato-box-mobile">
            <img src={prato.foto} alt={prato.nome} className="prato-foto-mobile" />
            <h2>{prato.nome}</h2>
            <span className='obs-mobile'>Imagens meramente ilustrativas</span>
          </div>
        ))}
      </div>
    </div>
...
export default GastronomiaPageMobile;
